package com.gouveia.android_main.gdc.core.notification
...
import com.gouveia.android_main.databinding.FragmentGdcNotificationBinding
...
class GdcNotificationFragment : Fragment(R.layout.fragment_gdc_notification) {
    ...
    private fun setupBtnStates(enableNotify: Boolean, enableUpdate: Boolean, enableCancel: Boolean) {
    ...
    inner class NotificationReceiver : BroadcastReceiver() {
        override fun onReceive(context: Context, intent: Intent) {
            ...
            when (intent.action) {
                ...
                ACTION_DELETE_ALL -> setupBtnStates(enableNotify = true, enableUpdate = false, enableCancel = false)
            }
        }
    }
